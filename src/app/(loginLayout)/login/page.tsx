...
import backgroundImage from '../../../../public/login page background image.jpg';
const Login = () => {
    ...
    return (
        <div className="relative ">
            <div className="flex justify-center bg-center bg-no-repeat bg-cover bg-[url('https://res.cloudinary.com/durkh1c9d/image/upload/v1739206550/16332411_rm347-porpla-02-a-01_wtlxmc.jpg')] items-center h-screen">
